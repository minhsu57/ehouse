        ...
        <div class="col-xs-12">
            <div class="col-xs-12 ">
                <div class="pull-right">
                    <!-- <button class="btn btn-primary btn-lg btn-sm" name="submit"><li class="fa fa-plus"></li> SAVE</button> -->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group col-md-12 col-lg-12">
                ...
                echo form_input('short_content', '','class="form-control"');
                ?>
            </div>
            <div class="form-group col-md-12 col-lg-12">
            ...
            <div class="form-group col-md-12 col-lg-12">
                ...
                echo form_input('keyword', '','class="form-control"');
                ?>
            </div>
            <div class="form-group col-md-12 col-lg-12">
                <?php
                ...
                echo form_input('meta_description', '','class="form-control"');
                ?>
            </div>
