...
class Users_model extends MY_Model
{
    ...
    public function get_list_record($first_name, $last_name, $email, $phone, $active){
    	$rows = $this->db->query('select *  from users where first_name like "'.$first_name.'%" and last_name like "'.$last_name.'%" and email like "'.$email.'%" and phone like "'.$phone.'%" and active like "'.$active.'%"');
